...
ggplot(
  data = data.frame(
    ...
    iter_60000 = c(334.170646,666.771699,1,1,1 ),
  ...
  geom_smooth(aes(y = iter_100000, color = "100000"), method = "lm", se = FALSE) +
  ...
  geom_smooth(aes(y = c(110.703507, 448.680679, 1050.975947, 1863.592248, 2925.219894)),
    method = "lm",
    formula = y ~ poly(x, 2),
    linetype = "dotted",
    se = FALSE) +
