...
It is also worth noting that while the cache behaviour of Setonix was researched, we came to the conclusion that it was not possible to perform conclusive experiments as the closed source nature of Pawsey means we do not know what chunk size is used. Thus, we do not explore cache behaviour in this report.
